...
fun RoadEventEntity.toModel(): RoadEvent = RoadEvent(
    ...
    intensity = intensity,
    speedKmh = speedKmh,
    anomalyType = AnomalyType.entries.firstOrNull { it.value == anomalyType } ?: AnomalyType.UNKNOWN,
    vehicleType = VehicleType.entries.firstOrNull { it.value == vehicleType } ?: VehicleType.FOUR_WHEELER,
